...
type ClientStatsPayload struct {
	...
	// the ID of the entity sending the stats. Functionally the same as the dogstatsd
	// 'dd.internal.entity_id' tag.
	EntityID string `protobuf:"bytes,11,opt,name=entityID,proto3" json:"entityID,omitempty"`
	// the tags associated with the entityID
	EntityTags []string `protobuf:"bytes,12,rep,name=entityTags" json:"entityTags,omitempty"`
}
...
func (m *ClientStatsPayload) MarshalTo(data []byte) (int, error) {
	...
	if len(m.EntityID) > 0 {
		data[i] = 0x5a
		i++
		i = encodeVarintStats(data, i, uint64(len(m.EntityID)))
		i += copy(data[i:], m.EntityID)
	}
	if len(m.EntityTags) > 0 {
		for _, s := range m.EntityTags {
			data[i] = 0x62
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *ClientStatsPayload) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EntityTags", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EntityTags = append(m.EntityTags, string(data[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipStats(data[iNdEx:])
...
var fileDescriptorStats = []byte{
	...
	,
}
